...
class Tuberculosis extends StatefulWidget {
  ...
  @override
  State<Tuberculosis> createState() => _TuberculosisState();
}

class _TuberculosisState extends State<Tuberculosis> {
  getCurrentDate() {
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: Image.asset(
              'assets/Images/Tuberculosis.png',
            ),
          ),
          Container(
            //color: Colors.red,
        ...
        onPressed: () async {
          if (_donate.text == "") {
            ...
            Map<String, String> dataToSave = {
              ...
              'Name': 'Tuberculosis Funding',
              'Date': "${getCurrentDate()}",
              'Amout': _donate.text,
            };
            FirebaseFirestore.instance
                .collection('TuberculosisFunding')
                .add(dataToSave);
            payment();
            showDialog(
                context: context,
