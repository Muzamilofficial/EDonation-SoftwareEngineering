...
class alkhidmat extends StatefulWidget {
  alkhidmat();

  @override
  State<alkhidmat> createState() => _alkhidmatState();
}

class _alkhidmatState extends State<alkhidmat> {
  getCurrentDate() {
