...
class aurat extends StatefulWidget {
  aurat();

  @override
  State<aurat> createState() => _auratState();
}

class _auratState extends State<aurat> {
  getCurrentDate() {
      ...
      child: Column(
        children: [
          ...
          Container(
            //color: Colors.red,
            alignment: Alignment.center,
            margin: const EdgeInsets.only(left: 5.0, right: 0.0,top: 40),
            //padding: const EdgeInsets.only(left: 20.0, right: 0.0),
        ...
        onPressed: () async {
          if (_donate.text == "") {
            ...
            Map<String, String> dataToSave = {
              ...
              'Organization Name': 'Aurat Foundation',
              'Date': "${getCurrentDate()}",
              'Amout': _donate.text,
            };
